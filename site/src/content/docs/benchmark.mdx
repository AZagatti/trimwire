...
description: A transparent, directional ranking of local summarizer models, from benchmark rows shared by trimwire users who opted in via `trimwire share benchmark`.
template: splash
head:
