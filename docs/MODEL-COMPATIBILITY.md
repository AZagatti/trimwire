...
| **glm-5.2** | Z.ai | **10/10** | 100% | (Z.ai sub) | ✦ newest GLM-5.x; top of the Z.ai subscription lane |
...
| **qwen3.5:4b (local @60 KB)** | ollama | **10/10** | 100% | free | the local default (N=10 @60 KB; see detail below — do NOT raise past ~60 KB) |
...
|---|---|
| qwen3.5:4b (default) | 100% (N=10 @60 KB; the recommended local model) |
...
| Already on a Z.ai plan | **glm-5 / glm-5-turbo / glm-5.1 / glm-5.2** (5.2 newest) | anthropic · `api.z.ai/api/anthropic` | coding-plan subscription |
...
- **Reliable @128 KB (N=10, all-pass):** minimax/minimax-m3, deepseek/deepseek-v4-pro,
  deepseek/deepseek-v4-flash, Z.ai glm-5 / glm-5-turbo / glm-5.1 / glm-5.2, and local
  qwen3.5:4b (@60 KB). Best value: **minimax-m3** (~$0.003/run); newest Z.ai: **glm-5.2**.
