...
> **real, aggregated numbers come from opted-in users** via
> `trimwire share benchmark` and live on the community **benchmark/dashboard** (which
> fills in over time). Don't read this table as community results.
